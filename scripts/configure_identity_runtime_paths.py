...
def main() -> int:
    ...
    ap.add_argument("--identity-home", default="/Users/yangxi/.codex/identity")
    ap.add_argument("--protocol-home", default=str(Path.cwd().resolve()))
    ap.add_argument("--config-path", default="/Users/yangxi/.codex/identity/config/runtime-paths.env")
    args = ap.parse_args()
