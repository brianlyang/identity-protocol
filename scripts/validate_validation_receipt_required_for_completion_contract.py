...
from validation_receipt_required_for_completion_contract_common import (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Validate the ISSUE-042B validation-receipt-required-for-completion contract."
    )
