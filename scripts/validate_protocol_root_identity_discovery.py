...
def main() -> int:
    ...
    payload = {
        ...
        **project_named_row_family_statuses(
            ...
            specs=(
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="identity_discovery_completeness_row_coverage_status",
                    family_id="identity_discovery_completeness_rows",
                    status_key="coverage_status",
                ),
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="identity_discovery_completeness_row_identity_projection_status",
                    family_id="identity_discovery_completeness_rows",
                    status_key="identity_projection_status",
                ),
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="identity_discovery_completeness_surface_coverage_status",
                    family_id="identity_discovery_completeness_surface",
                    status_key="coverage_status",
                ),
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="identity_discovery_completeness_surface_identity_projection_status",
                    family_id="identity_discovery_completeness_surface",
                    status_key="identity_projection_status",
                ),
            ),
