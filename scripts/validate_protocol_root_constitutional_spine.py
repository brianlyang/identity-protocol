...
def main() -> int:
    ...
    payload = {
        ...
        **project_named_row_family_statuses(
            ...
            specs=(
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="constitutional_entry_row_coverage_status",
                    family_id="constitutional_entry_rows",
                    status_key="coverage_status",
                ),
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="constitutional_entry_row_identity_projection_status",
                    family_id="constitutional_entry_rows",
                    status_key="identity_projection_status",
                ),
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="spine_bridge_row_coverage_status",
                    family_id="spine_bridge_rows",
                    status_key="coverage_status",
                ),
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="spine_bridge_row_identity_projection_status",
                    family_id="spine_bridge_rows",
                    status_key="identity_projection_status",
                ),
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="philosophy_primacy_row_coverage_status",
                    family_id="philosophy_primacy_rows",
                    status_key="coverage_status",
                ),
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="philosophy_primacy_row_identity_projection_status",
                    family_id="philosophy_primacy_rows",
                    status_key="identity_projection_status",
                ),
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="philosophy_primacy_surface_coverage_status",
                    family_id="philosophy_primacy_surface",
                    status_key="coverage_status",
                ),
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="philosophy_primacy_surface_identity_projection_status",
                    family_id="philosophy_primacy_surface",
                    status_key="identity_projection_status",
                ),
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="constitutional_spine_completeness_row_coverage_status",
                    family_id="constitutional_spine_completeness_rows",
                    status_key="coverage_status",
                ),
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="constitutional_spine_completeness_row_identity_projection_status",
                    family_id="constitutional_spine_completeness_rows",
                    status_key="identity_projection_status",
                ),
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="constitutional_spine_completeness_surface_coverage_status",
                    family_id="constitutional_spine_completeness_surface",
                    status_key="coverage_status",
                ),
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="constitutional_spine_completeness_surface_identity_projection_status",
                    family_id="constitutional_spine_completeness_surface",
                    status_key="identity_projection_status",
                ),
            ),
