...
for ID in $IDS; do
  ...
  echo "[23.4296/30][$ID] validate discovery requiredization bridge (ASB-RQ-062..066)"
  ...
  echo "[23.452/30][$ID] validate intake evidence quorum gate (RQ-030)"
  ...
  echo "[23.453/30][$ID] validate route/workflow version pinning gate (RQ-021)"
  ...
  echo "[23.454/30][$ID] validate fallback taxonomy normalization gate (RQ-022)"
  ...
  echo "[23.455/30][$ID] validate dedup monotonic winner gate (RQ-018)"
  ...
  echo "[23.456/30][$ID] validate cross-workflow schema gate (RQ-019)"
  ...
  echo "[23.457/30][$ID] validate skill path integrity gate (RQ-020)"
