...
def main() -> int:
    ...
    if not error_code and (primacy_violations or integration_violations or contract_marker_violations or root_doc_anchor_violations):
    ...
    stale_reasons.extend(
        ...
        for row in primacy_violations + integration_violations + contract_marker_violations + root_doc_anchor_violations
    )
