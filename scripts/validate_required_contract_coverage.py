...
STATUS_FIELD_BY_SCRIPT = {
    ...
    "scripts/validate_cross_verification_tracks.py": "cross_verification_tracks_status",
    "scripts/validate_intake_evidence_quorum.py": "intake_evidence_quorum_status",
    ...
    "scripts/validate_cross_workflow_schema.py": "cross_workflow_schema_status",
        "scripts/validate_skill_path_integrity.py": "path_integrity_status",
    ...
    "scripts/validate_terminal_truth_cleanliness.py": "identity_terminal_truth_cleanliness_status",
}
...
TARGETS = (
    ...
    ContractTarget(
        ...
        validator_script="scripts/validate_cross_verification_tracks.py",
        validator_args=("--json-only",),
    ),
    ContractTarget(
        ...
        validator_script="scripts/validate_intake_evidence_quorum.py",
        validator_args=("--json-only",),
    ),
    ContractTarget(
    ...
    ContractTarget(
        ...
        validator_script="scripts/validate_cross_workflow_schema.py",
        validator_args=("--json-only",),
    ),
    ContractTarget(
    ...
    ContractTarget(
        name="identity_terminal_truth_cleanliness",
        contract_keys=(
            TERMINAL_TRUTH_CLEANLINESS_CONTRACT_KEY,
            TERMINAL_TRUTH_CLEANLINESS_CONTRACT_ID,
        ),
        validator_script="scripts/validate_terminal_truth_cleanliness.py",
        validator_args=("--json-only",),
        instance_adopted_protocol_target=True,
    ),
    ContractTarget(
