...
def _lane_summary(*, workbook: dict[str, Any], stream_scope: dict[str, Any], launcher_probe: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "stream_touch_reason": stream_touch_reason,
    }
...
def main() -> int:
    ...
    stream_scope = _run_json(profile.stream_scope_cmd, cwd=workspace_root)
    ...
    lane_summary = _lane_summary(workbook=workbook, stream_scope=stream_scope, launcher_probe=launcher_probe)
    payload = {
        ...
        "summary_lines": [
            ...
            f"stream-touch evidence={lane_summary['stream_touch_evidence_status']} ({lane_summary['stream_touch_reason']})",
        ],
    }
    _emit(payload, json_only=args.json_only)
