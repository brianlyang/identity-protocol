#!/usr/bin/env python3
"""Validate ISSUE-040B lane_execution_receipt_contract_v1."""
...
def build_report(governance_doc: Path, review_doc: Path) -> dict[str, object]:
    ...
    return {
        "lane_execution_receipt_contract_status": status,
...
def main() -> int:
    ...
    return 0 if report["lane_execution_receipt_contract_status"] == STATUS_PASS_REQUIRED else 1
