...
repo_global_topology_positive_output_rel="$(
  resolve_python_module_expression \
    "release_readiness_repo_global_closure_projection_common" \
...
if run_shadow_validator "${TMP_ROOT}" "${TMP_ROOT}/release-readiness-repo-global-closure-topology-negative-summary-key.json"; then
...
if run_shadow_validator "${TMP_ROOT}" "${TMP_ROOT}/release-readiness-repo-global-closure-topology-negative-one-look-field.json"; then
...
mutate_probe_literal \
  ...
  ''
if run_shadow_validator "${TMP_ROOT}" "${TMP_ROOT}/release-readiness-repo-global-closure-topology-negative-capture-map.json"; then
...
mutate_probe_literal \
  ...
  ''
if run_shadow_validator "${TMP_ROOT}" "${TMP_ROOT}/release-readiness-repo-global-closure-topology-negative-structured-capture.json"; then
...
mutate_probe_literal \
  ...
  ''
if run_shadow_validator "${TMP_ROOT}" "${TMP_ROOT}/release-readiness-repo-global-closure-topology-negative-summary-defaults.json"; then
...
mutate_probe_literal \
  ...
  ''
if run_shadow_validator "${TMP_ROOT}" "${TMP_ROOT}/release-readiness-repo-global-closure-topology-negative-missing-validator-command.json"; then
...
mutate_probe_literal \
  ...
  ''
if run_shadow_validator "${TMP_ROOT}" "${TMP_ROOT}/release-readiness-repo-global-closure-topology-negative-missing-probe-command.json"; then
...
mutate_probe_literal \
  ...
  'stale_reason="repo_global_summary_probe_projection_guard"'
if run_shadow_validator "${TMP_ROOT}" "${TMP_ROOT}/release-readiness-repo-global-closure-topology-negative-summary-projection.json"; then
...
mutate_probe_literal \
  ...
  'stale_reason="repo_global_summary_probe_checked_count_guard"'
if run_shadow_validator "${TMP_ROOT}" "${TMP_ROOT}/release-readiness-repo-global-closure-topology-negative-summary-checked-count.json"; then
...
mutate_probe_literal \
  ...
  'stale_reason="repo_global_summary_probe_topology_lane_guard"'
if run_shadow_validator "${TMP_ROOT}" "${TMP_ROOT}/release-readiness-repo-global-closure-topology-negative-summary-topology-lane.json"; then
...
mutate_probe_literal \
  ...
  'stale_reason="repo_global_boundary_probe_projection_guard"'
if run_shadow_validator "${TMP_ROOT}" "${TMP_ROOT}/release-readiness-repo-global-closure-topology-negative-boundary-projection.json"; then
...
mutate_probe_literal \
  ...
  'stale_reason="repo_global_boundary_probe_checked_count_guard"'
if run_shadow_validator "${TMP_ROOT}" "${TMP_ROOT}/release-readiness-repo-global-closure-topology-negative-boundary-checked-count.json"; then
...
mutate_probe_literal \
  ...
  'stale_reason="repo_global_boundary_probe_topology_lane_guard"'
if run_shadow_validator "${TMP_ROOT}" "${TMP_ROOT}/release-readiness-repo-global-closure-topology-negative-boundary-topology-lane.json"; then
...
if run_shadow_validator "${TMP_ROOT}" "${TMP_ROOT}/release-readiness-repo-global-closure-topology-negative-governance-field.json"; then
...
if run_shadow_validator "${TMP_ROOT}" "${TMP_ROOT}/release-readiness-repo-global-closure-topology-negative-summary-binding.json"; then
...
if run_shadow_validator "${TMP_ROOT}" "${TMP_ROOT}/release-readiness-repo-global-closure-topology-negative-probe-self-check.json"; then
