...
THREAD_SEED="$(date -u +%Y%m%dT%H%M%SZ)-$$-${RANDOM}"
THREAD_ID_A="probe-dialogue-retention-active-${THREAD_SEED}"
THREAD_ID_B="probe-dialogue-retention-historical-${THREAD_SEED}"
SOURCE_SESSION_FILE_A="${CODEX_HOME_FIXTURE}/sessions/probe/active/rollout-${THREAD_ID_A}.jsonl"
SOURCE_SESSION_FILE_B="${CODEX_HOME_FIXTURE}/sessions/probe/historical/rollout-${THREAD_ID_B}.jsonl"
