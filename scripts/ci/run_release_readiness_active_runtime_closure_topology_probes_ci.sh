...
TMP_ROOT="$(mktemp -d "${TMPDIR:-/tmp}/release-readiness-active-runtime-closure-topology-ci.XXXXXX")"
...
if run_shadow_validator "${TMP_ROOT}" /tmp/release-readiness-active-runtime-closure-topology-negative-summary-key.json; then
...
if run_shadow_validator "${TMP_ROOT}" /tmp/release-readiness-active-runtime-closure-topology-negative-one-look-field.json; then
...
mutate_probe_literal \
  ...
  ''
if run_shadow_validator "${TMP_ROOT}" /tmp/release-readiness-active-runtime-closure-topology-negative-capture-map.json; then
...
mutate_probe_literal \
  ...
  ''
if run_shadow_validator "${TMP_ROOT}" /tmp/release-readiness-active-runtime-closure-topology-negative-structured-capture.json; then
...
mutate_probe_literal \
  ...
  ''
if run_shadow_validator "${TMP_ROOT}" /tmp/release-readiness-active-runtime-closure-topology-negative-summary-defaults.json; then
...
if run_shadow_validator "${TMP_ROOT}" /tmp/release-readiness-active-runtime-closure-topology-negative-summary-probe-resolution.json; then
