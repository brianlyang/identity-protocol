...
release_closure_root_grounding_lane_marker="$(
  resolve_python_module_expression \
    "release_closure_root_grounding_common" \
    "next(marker for marker in RELEASE_CLOSURE_ROOT_GROUNDING_LANE_MARKERS if marker.endswith('protocol_root_success_path_state_admissibility'))"
)"
release_closure_root_grounding_validator_path="$(
  resolve_python_module_expression \
    "release_closure_root_grounding_common" \
    "next(spec.validator_rel for spec in RELEASE_CLOSURE_ROOT_GROUNDING_LANE_SPECS if spec.lane_id == 'protocol_root_success_path_state_admissibility')"
)"
release_closure_root_grounding_probe_path="$(
  resolve_python_module_expression \
    "release_closure_root_grounding_common" \
    "next(spec.probe_rel for spec in RELEASE_CLOSURE_ROOT_GROUNDING_LANE_SPECS if spec.lane_id == 'protocol_root_success_path_state_admissibility')"
)"
