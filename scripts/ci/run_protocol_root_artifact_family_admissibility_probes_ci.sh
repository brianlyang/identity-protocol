...
path = pathlib.Path(sys.argv[1])
text = path.read_text(encoding="utf-8")
section_marker = "## Root artifact-family admissibility completeness discipline"
next_marker = "\n---\n\n## Root current-truth epistemology completeness discipline"
first = "1. required family-admission-class, differentiation, proof, limit, and collapse rows must remain explicit as separate machine-readable families;"
...
swapped_second = "2. required family-admission-class, differentiation, proof, limit, and collapse rows must remain explicit as separate machine-readable families;"
