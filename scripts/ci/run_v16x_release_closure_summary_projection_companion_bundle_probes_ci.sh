...
PROJECTION_COMPANION_PROBE_COMMON="${REPO_ROOT}/scripts/release_closure_projection_companion_probe_common.py"
...
python3 "${PROJECTION_COMPANION_PROBE_COMMON}" \
  mutate \
  --surface summary \
  --summary-path "${SUMMARY_SHADOW_PATH}"
