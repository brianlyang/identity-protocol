...
release_closure_root_grounding_lane_marker="$(
  resolve_python_module_expression \
    "release_closure_root_grounding_common" \
    "next(marker for marker in RELEASE_CLOSURE_ROOT_GROUNDING_LANE_MARKERS if marker.endswith('protocol_root_identity_instance_self_judgement'))"
)"
release_closure_root_grounding_validator_path="$(
  resolve_python_module_expression \
    "release_closure_root_grounding_common" \
    "next(spec.validator_rel for spec in RELEASE_CLOSURE_ROOT_GROUNDING_LANE_SPECS if spec.lane_id == 'protocol_root_identity_instance_self_judgement')"
)"
release_closure_root_grounding_probe_path="$(
  resolve_python_module_expression \
    "release_closure_root_grounding_common" \
    "next(spec.probe_rel for spec in RELEASE_CLOSURE_ROOT_GROUNDING_LANE_SPECS if spec.lane_id == 'protocol_root_identity_instance_self_judgement')"
)"
...
terminal_truth_bridge_review_required_case_marker = sys.argv[7]
terminal_truth_bridge_explicit_dirty_retry_case_marker = sys.argv[8]
terminal_truth_bridge_probe_marker = sys.argv[9]
active_runtime_terminal_truth_veto_marker = sys.argv[10]
post_closure_adjudication_order_marker = sys.argv[11]
release_closure_root_grounding_order_marker = sys.argv[12]
release_closure_root_grounding_lane_marker = sys.argv[13]
release_closure_root_grounding_validator_path = sys.argv[14]
release_closure_root_grounding_probe_path = sys.argv[15]
...
terminal_truth_bridge_review_required_case_marker = sys.argv[8]
terminal_truth_bridge_explicit_dirty_retry_case_marker = sys.argv[9]
terminal_truth_bridge_probe_marker = sys.argv[10]
active_runtime_terminal_truth_veto_marker = sys.argv[11]
...
expected_review_required_case_reason = f"governance_doc_missing_terminal_truth_bridge_marker:{terminal_truth_bridge_review_required_case_marker}"
if expected_review_required_case_reason not in reasons:
    raise SystemExit("negative release-closure boundary must detect review-required terminal-truth bridge case drift")
expected_explicit_dirty_retry_case_reason = f"governance_doc_missing_terminal_truth_bridge_marker:{terminal_truth_bridge_explicit_dirty_retry_case_marker}"
if expected_explicit_dirty_retry_case_reason not in reasons:
    raise SystemExit("negative release-closure boundary must detect explicit-dirty-retry terminal-truth bridge case drift")
...
expected_post_closure_adjudication_reason = (
    f"governance_doc_missing_post_closure_adjudication_marker:{sys.argv[12]}"
)
...
expected_root_grounding_probe_reason = (
    f"governance_doc_missing_release_closure_root_grounding_marker:{sys.argv[16]}"
)
