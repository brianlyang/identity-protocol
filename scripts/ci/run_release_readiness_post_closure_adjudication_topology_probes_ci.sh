...
run_shadow_validator() {
  ...
  PYTHONPATH="${shadow_root}/scripts${PYTHONPATH:+:${PYTHONPATH}}" \
    python3 "${shadow_root}/scripts/validate_release_readiness_post_closure_adjudication_topology.py" \
...
python3 scripts/validate_release_readiness_post_closure_adjudication_topology.py --json-only >"${POSITIVE_JSON}"
...
restore_shadow_file "${TMP_ROOT}" "scripts/release_readiness_check.py"
# expected fail-close: post_closure_bundle_missing_validator:scripts/validate_release_readiness_post_closure_adjudication_topology.py --json-only
mutate_probe_literal \
...
restore_shadow_file "${TMP_ROOT}" "scripts/release_readiness_check.py"
# expected fail-close: post_closure_bundle_missing_probe:scripts/ci/run_release_readiness_post_closure_adjudication_topology_probes_ci.sh
mutate_probe_literal \
  "${TMP_ROOT}/scripts/release_readiness_check.py" \
...
# expected fail-close: summary_binding_probe_missing_token:release_readiness_post_closure_adjudication_topology_probe
mutate_probe_literal \
...
restore_shadow_file "${TMP_ROOT}" "scripts/ci/run_release_readiness_post_closure_adjudication_topology_probes_ci.sh"
mutate_probe_literal \
  "${TMP_ROOT}/scripts/ci/run_release_readiness_post_closure_adjudication_topology_probes_ci.sh" \
...
print(json.dumps({
    "release_readiness_post_closure_adjudication_topology_probe_status": "PASS_REQUIRED",
