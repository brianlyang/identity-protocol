#!/usr/bin/env python3
"""Validate ISSUE-040A lane_card_handoff_contract_v1."""
...
from lane_card_handoff_contract_common import (
    EXPECTED_CONTRACT,
    REQUIRED_FIELDS,
...
def build_report(governance_doc: Path, review_doc: Path) -> dict[str, object]:
    ...
    return {
        "lane_card_handoff_contract_status": status,
...
def main() -> int:
    ...
    return 0 if report["lane_card_handoff_contract_status"] == STATUS_PASS_REQUIRED else 1
