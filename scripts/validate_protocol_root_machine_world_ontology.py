...
from root_machine_world_ontology_common import (
    ...
    machine_world_ontology_completeness_rows_from_doc,
    ontology_limit_rows_from_doc,
    ontology_proof_rows_from_doc,
    object_rows_from_doc,
    readme_machine_world_ontology_completeness_surface,
...
EXPECTED_MACHINE_WORLD_ONTOLOGY_COMPLETENESS_ROWS = {
    "explicit_machine_world_ontology_row_families": {
        "order": 1,
        "contract_phrase": "required strata, object, ontology-proof, ontology-limit, and collapse rows must remain explicit as separate machine-readable families;",
    },
    "congruent_machine_world_ontology_row_family_totals": {
        "order": 2,
    ...
    "explicit_machine_world_ontology_row_identity_sets": {
        "order": 3,
    ...
    "hidden_machine_world_ontology_identity_drift_forbidden": {
        "order": 4,
        "contract_phrase": "runtime or validator code must not finalize machine-world ontology legality while missing or unexpected row identities remain known only internally;",
    },
    "fail_close_preserves_machine_world_ontology_identity_projection": {
        "order": 5,
...
EXPECTED_ROOT_DOC_ANCHOR_CHECKS = {
    "identity/protocol/IDENTITY_PROTOCOL_DESIGN_PHILOSOPHY.md": (
        ...
        "README root machine-world ontology completeness discipline must therefore stay congruent with admitted machine-world-ontology-completeness rows rather than becoming a freehand completeness summary.",
    ),
    ...
    "identity/protocol/IDENTITY_PROTOCOL.md": (
        ...
        "6. README root machine-world ontology completeness discipline rendered at protocol root must remain congruent with admitted machine-world-ontology-completeness rows rather than silently authoring an alternate completeness summary.",
    ),
    "identity/protocol/IDENTITY_RUNTIME.md": (
        ...
        "6. Runtime consumes README root machine-world ontology completeness discipline as a governed completeness projection bound to admitted machine-world-ontology-completeness rows rather than as a freehand completeness summary.",
    ),
}
...
def main() -> int:
    ...
    machine_world_ontology_completeness_rows = (
        machine_world_ontology_completeness_rows_from_doc(ontology_doc) if ontology_doc else ()
    )
    machine_world_ontology_completeness_surface = readme_machine_world_ontology_completeness_surface(repo_root)
    ...
    if not stale_reasons:
        ...
        for field, rows in (
            ...
            if not rows:
                ...
                error_code = ERR_REGISTRY
        if not machine_world_ontology_completeness_rows:
            stale_reasons.append("root_machine_world_ontology_completeness_rows_missing")
            error_code = ERR_REGISTRY
    ...
    if not stale_reasons:
        row_family_projection_rows = project_row_families(
            families=(
                ...
                {
                    "family_id": "machine_world_ontology_completeness_rows",
                    "member_id_key": "completeness_id",
                    "actual_rows": machine_world_ontology_completeness_rows,
                    "expected_rows": {
                        completeness_id: {} for completeness_id in EXPECTED_MACHINE_WORLD_ONTOLOGY_COMPLETENESS_ROWS
                    },
                    "id_attr": "completeness_id",
                },
                {
                    "family_id": "machine_world_ontology_completeness_surface",
                    "member_id_key": "contract_phrase",
                    "actual_rows": machine_world_ontology_completeness_surface.rows,
                    "expected_rows": {
                        row["contract_phrase"]: {} for row in EXPECTED_MACHINE_WORLD_ONTOLOGY_COMPLETENESS_ROWS.values()
                    },
        ...
        validate_contract_row_batches(
            batches=(
                ...
                {
                    "actual_rows": machine_world_ontology_completeness_rows,
                    "expected_rows": EXPECTED_MACHINE_WORLD_ONTOLOGY_COMPLETENESS_ROWS,
                    "field_name": "machine_world_ontology_completeness_rows",
                    "id_attr": "completeness_id",
                    "compare_fields": ("contract_phrase",),
                    "duplicate_reason": "duplicate_machine_world_ontology_completeness_id",
                    "non_contiguous_reason": "machine_world_ontology_completeness_row_order_non_contiguous",
                    "missing_reason": "missing_machine_world_ontology_completeness_rows",
                    "extra_reason": "extra_machine_world_ontology_completeness_rows",
                    "missing_ids_key": "completeness_ids",
                    "extra_ids_key": "completeness_ids",
                    "violation_id_key": "completeness_id",
                    "order_reason": "machine_world_ontology_completeness_row_order_mismatch",
                },
                {
                    "actual_rows": machine_world_ontology_completeness_surface.rows,
                    "expected_rows": {
                        row["contract_phrase"]: {"order": int(row["order"])}
                        for row in EXPECTED_MACHINE_WORLD_ONTOLOGY_COMPLETENESS_ROWS.values()
                    },
                    "field_name": "machine_world_ontology_completeness_surface",
                    "id_attr": "contract_phrase",
                    "compare_fields": (),
                    "duplicate_reason": "duplicate_machine_world_ontology_completeness_surface_phrase",
                    "non_contiguous_reason": "machine_world_ontology_completeness_surface_order_non_contiguous",
                    "missing_reason": "missing_machine_world_ontology_completeness_surface_rows",
                    "extra_reason": "extra_machine_world_ontology_completeness_surface_rows",
                    "missing_ids_key": "contract_phrases",
                    "extra_ids_key": "contract_phrases",
                    "violation_id_key": "contract_phrase",
                    "order_reason": "machine_world_ontology_completeness_surface_order_mismatch",
                },
            ),
        ...
        expected_machine_world_ontology_completeness_phrases = [
            row["contract_phrase"] for row in EXPECTED_MACHINE_WORLD_ONTOLOGY_COMPLETENESS_ROWS.values()
        ]
        actual_machine_world_ontology_completeness_phrases = [
            row.contract_phrase for row in machine_world_ontology_completeness_surface.rows
        ]
        expected_machine_world_ontology_completeness_orders = [
            int(row["order"]) for row in EXPECTED_MACHINE_WORLD_ONTOLOGY_COMPLETENESS_ROWS.values()
        ]
        actual_machine_world_ontology_completeness_orders = [
            row.order for row in machine_world_ontology_completeness_surface.rows
        ]
        for reason in machine_world_ontology_completeness_surface.extraction_violations:
            structure_violations.append(
                {
                    "field": "machine_world_ontology_completeness_surface",
                    "reason": f"machine_world_ontology_completeness_surface_{reason}",
                }
            )
        if actual_machine_world_ontology_completeness_phrases and tuple(
            actual_machine_world_ontology_completeness_phrases
        ) != tuple(expected_machine_world_ontology_completeness_phrases):
            ontology_violations.append(
                {
                    "field": "machine_world_ontology_completeness_surface",
                    "reason": "machine_world_ontology_completeness_surface_phrase_order_mismatch",
                    "expected": expected_machine_world_ontology_completeness_phrases,
                    "actual": actual_machine_world_ontology_completeness_phrases,
                }
            )
        if actual_machine_world_ontology_completeness_orders and tuple(
            actual_machine_world_ontology_completeness_orders
        ) != tuple(expected_machine_world_ontology_completeness_orders):
            ontology_violations.append(
                {
                    "field": "machine_world_ontology_completeness_surface",
                    "reason": "machine_world_ontology_completeness_surface_order_mismatch",
                    "expected": expected_machine_world_ontology_completeness_orders,
                    "actual": actual_machine_world_ontology_completeness_orders,
                }
            )
    ...
    payload: dict[str, Any] = {
        ...
        "machine_world_ontology_completeness_row_count": len(machine_world_ontology_completeness_rows),
        **project_root_contract_support_projection(
        ...
        **project_named_row_family_statuses(
            ...
            specs=(
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="machine_world_ontology_completeness_row_coverage_status",
                    family_id="machine_world_ontology_completeness_rows",
                    status_key="coverage_status",
                ),
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="machine_world_ontology_completeness_row_identity_projection_status",
                    family_id="machine_world_ontology_completeness_rows",
                    status_key="identity_projection_status",
                ),
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="machine_world_ontology_completeness_surface_coverage_status",
                    family_id="machine_world_ontology_completeness_surface",
                    status_key="coverage_status",
                ),
                NamedRowFamilyStatusProjectionSpec(
                    payload_key="machine_world_ontology_completeness_surface_identity_projection_status",
                    family_id="machine_world_ontology_completeness_surface",
                    status_key="identity_projection_status",
                ),
            ),
        ...
        "machine_world_ontology_completeness_rows": [
            ...
            for row in sorted(machine_world_ontology_completeness_rows, key=lambda item: item.order)
        ],
        "machine_world_ontology_completeness_surface": {
            "rel_path": machine_world_ontology_completeness_surface.rel_path,
            "entry_count": len(machine_world_ontology_completeness_surface.rows),
            "entries": [
                {
                    "order": row.order,
                    "contract_phrase": row.contract_phrase,
                }
                for row in machine_world_ontology_completeness_surface.rows
            ],
            "extraction_violations": list(machine_world_ontology_completeness_surface.extraction_violations),
        },
        "structure_violations": structure_violations,
        "ontology_violations": ontology_violations,
