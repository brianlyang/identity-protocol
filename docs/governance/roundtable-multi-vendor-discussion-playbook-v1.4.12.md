...
Use repository-governed outputs (must exist under `docs/governance/`):

1. `docs/governance/roundtable-multi-agent-multi-identity-binding-governance-v1.4.12.md` (final policy decisions)
2. `docs/governance/identity-runtime-path-selection-governance-v1.4.12.md` (runtime path strategy and enforcement)
3. `docs/governance/identity-instance-closure-checklist-v1.4.12.md` (command-ready closure checklist)
4. `docs/governance/audit-unified-result-package-v1.4.12.md` (P0/P1 backlog + release posture summary)

Optional attachments (if meeting needs extra granularity):

- `docs/governance/roundtable-arbitration-schema-v1.4.12.json`
- `docs/governance/roundtable-open-questions-v1.4.12.md`
...
## 12.1 Post-roundtable execution handoff

After policy lock, execution teams should use:
...
as the mandatory closure playbook for migration/update/writeback verification, especially for sandbox-deferred writeback scenarios.
