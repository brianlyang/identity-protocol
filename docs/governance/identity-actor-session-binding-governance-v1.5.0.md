...
| ASB-RQ-075 / ASB-RQ-076 / ASB-RQ-077 / ASB-RQ-078 | `SPEC_READY -> GATE_READY (P0)` | `FIX-029` landed (`a95f5a2`): canonical reply-channel validator + sidecar `IP-PFB-*` strict blocking + split-receipt activity-requiredization bridge; independent replay audit pending (`review 16.8.21`) |
| ASB-RQ-079 / ASB-RQ-080 / ASB-RQ-081 | `SPEC_READY -> GATE_READY (P0)` | `FIX-030` landed (`a95f5a2`): bootstrap-ready validator + deterministic constructor + strict `IP-PFB-CH-004/005` semantics + telemetry surfaces; independent replay audit pending (`review 16.8.21`) |
| ASB-RQ-082 / ASB-RQ-083 / ASB-RQ-084 / ASB-RQ-085 | `SPEC_READY -> GATE_READY (P0)` | `FIX-031` landed (`a95f5a2`): candidate clarification bridge + deterministic question set + canonical seed/index linkage + anti-silent-downgrade semantics; independent replay audit pending (`review 16.8.21`) |
| ASB-RQ-086 / ASB-RQ-087 / ASB-RQ-088 / ASB-RQ-089 | `SPEC_READY -> GATE_READY (P0)` | `FIX-032` landed (`a95f5a2`): inquiry state machine + signal-origin sanitization + requiredization trigger bridge + strict `IP-LAYER-INQ-*` semantics; independent replay audit pending (`review 16.8.21`) |
