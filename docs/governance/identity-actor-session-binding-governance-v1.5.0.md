...
| ASB-RQ-075 / ASB-RQ-076 / ASB-RQ-077 / ASB-RQ-078 | `SPEC_READY -> IMPL_READY (BLOCKED_BY_AUDIT, P0)` | `FIX-029` landed (`a95f5a2`), but auditor replay found strict fail-closed and CWD-invariance gaps; see `review 16.8.21` (`REJECT`) |
| ASB-RQ-079 / ASB-RQ-080 / ASB-RQ-081 | `SPEC_READY -> IMPL_READY (BLOCKED_BY_AUDIT, P0)` | `FIX-030` landed (`a95f5a2`), but readiness pass-through and subprocess path determinism gaps remain; see `review 16.8.21` (`REJECT`) |
| ASB-RQ-082 / ASB-RQ-083 / ASB-RQ-084 / ASB-RQ-085 | `SPEC_READY -> IMPL_READY (BLOCKED_BY_AUDIT, P0)` | `FIX-031` landed (`a95f5a2`), but candidate bridge strict-chain proof is not yet robust under non-root invocation; see `review 16.8.21` (`REJECT`) |
| ASB-RQ-086 / ASB-RQ-087 / ASB-RQ-088 / ASB-RQ-089 | `SPEC_READY -> IMPL_READY (BLOCKED_BY_AUDIT, P0)` | `FIX-032` landed (`a95f5a2`), but inquiry state-machine emission correlation remains insufficient; see `review 16.8.21` (`REJECT`) |
