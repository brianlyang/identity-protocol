...
- `docs/governance/identity-host-unique-channel-governance-v1.6.6.md` — v1.6.6 dedicated host-channel closure stream for mandatory per-instance ingress/egress wrappers and wrapper-only dispatch/release against protocol canonical gates.
