...
## 17.1 Operations closure companion

For migration/writeback closure details after sandbox or permission-blocked runs, use:
...
This companion checklist is command-oriented and enforces WRITTEN-state completion before release promotion.
