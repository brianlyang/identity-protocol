# Protocol Remediation Audit Ledger v1.6.x — Governed Root Replay Exclusion

Minimal audit ledger skeleton for ISSUE-041C governed-root replay exclusion.
...
Acceptance notes:
- nested governed-root replay must stay excluded whenever governed roots are re-materialized inside governed scratch;
- replay-shaped paths fail admission rather than being kept by freeform interpretation;
- fail-close prevents heuristic cleanup from overreaching into live runtime.
